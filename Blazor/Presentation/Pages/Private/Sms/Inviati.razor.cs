...
{
    public partial class Inviati : IDisposable
    {
        [Inject]
        ...
        public void FiltraTextChange()
        {
            ...
            if (!__TextBox_MittenteSms.Value.IsNullOrEmpty())
            {
                list.Add("MittenteSms.Contains(@7)");
                whereObj.Add(__TextBox_MittenteSms.Value);
            }
